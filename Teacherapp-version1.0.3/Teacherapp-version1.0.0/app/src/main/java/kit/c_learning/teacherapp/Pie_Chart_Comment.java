...
public class Pie_Chart_Comment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pie_chart_comment);
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(Pie_Chart_Comment.this, android.R.layout.simple_list_item_1,
                getResources().getStringArray(R.array.displayQuestionnaires));
        myAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        displaySpinner.setAdapter(myAdapter);

        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(Pie_Chart_Comment.this, android.R.layout.simple_list_item_1,
...
//                }
        ...
        entries.add(new PieEntry(Float.parseFloat(per[1]),"1"));
        entries.add(new PieEntry(Float.parseFloat(per[2]),"2"));
