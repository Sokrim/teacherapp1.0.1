...
public class AgreeDisagree_PieChart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agree_disagree__pie_chart);
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(AgreeDisagree_PieChart.this, android.R.layout.simple_list_item_1,
                getResources().getStringArray(R.array.displayQuestionnaires));
        myAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        displaySpinner.setAdapter(myAdapter);

        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(AgreeDisagree_PieChart.this, android.R.layout.simple_list_item_1,
...
//                }
        ...
        entries.add(new PieEntry(Float.parseFloat(per[1]),"AGREE"));
        entries.add(new PieEntry(Float.parseFloat(per[2]),"DISAGREE"));
